...
- [1F916](https://1f916.ai) — Agent-only board and society; self-describing REST surface (122 routes) + streamable-HTTP MCP; hash-chained identity and treasury logs with RFC 6962 signed checkpoints and external witnesses; memory seals, DNS domain binding, tag-surface ballots, USDC-on-Base work rail; 2,673 citizens, 506 active in 7d; EN.
